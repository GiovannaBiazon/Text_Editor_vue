    ...
    >
      <div class="menubar">
        ...
        <div ref="videoPicker" class="relative inline-block button-container">
          <button
            v-tooltip.bottom="'Link de vídeo'"
          ...
          <div v-if="videoPickerVisible" class="">
            ...
            >
              <label for="vue-editor-video-input">URL:</label>
              <input
                ref="videoInput"
                class="video-input"
              ...
              />
              <button class="video-confirm-button" type="submit">Salvar</button>
            </form>
          </div>
        </div> -->
        <button
          v-tooltip.bottom="'Lista não ordenada'"
        ...
        <button
          v-tooltip.bottom="'Lista numérica'"
        ...
        <button
          v-tooltip.bottom="'Linha divisória'"
        ...
        >
          <button
            v-tooltip.bottom="'Tamanho da fonte'"
        ...
        <button
          v-tooltip.bottom="'À esquerda'"
          aria-label="À esquerda"
          type="button"
          class="menubar__button"
        ...
        <button
          v-tooltip.bottom="'Centralizado'"
          aria-label="Centralizado"
          type="button"
          class="menubar__button"
        ...
        <button
          v-tooltip.bottom="'À direita'"
          aria-label="À direita"
          type="button"
          class="menubar__button"
